...
publishing {
    publications {
        create<MavenPublication>("whitespaces") {
            artifactId = "whitespaces"
            ...
            pom {
                name.set("WhichLicense testing-libs/whitespaces")
                description.set("This library provides an internal JUnit 5 extension for whitespaces.")
                url.set("https://github.com/whichlicense/testing-libs/whitespaces")
                licenses {
                    license {
...
signing {
    if (project.hasProperty("CI")) {
        ...
        sign(publishing.publications["whitespaces"])
    }
}
