...
publishing {
    publications {
        create<MavenPublication>("filecontent") {
            artifactId = "filecontent"
            ...
            pom {
                name.set("WhichLicense testing-libs/filecontent")
                description.set("This library provides an internal JUnit 5 extension for file content access.")
                url.set("https://github.com/whichlicense/testing-libs/filecontent")
                licenses {
                    license {
...
signing {
    if (project.hasProperty("CI")) {
        ...
        sign(publishing.publications["filecontent"])
    }
}
