...
publishing {
    publications {
        create<MavenPublication>("fileref") {
            artifactId = "fileref"
            ...
            pom {
                name.set("WhichLicense testing-libs/fileref")
                description.set("This library provides an internal JUnit 5 extension for file references.")
                url.set("https://github.com/whichlicense/testing-libs/fileref")
                licenses {
                    license {
...
signing {
    if (project.hasProperty("CI")) {
        ...
        sign(publishing.publications["fileref"])
    }
}
