...
publishing {
    publications {
        create<MavenPublication>("naming") {
            artifactId = "naming"
            ...
            pom {
                name.set("WhichLicense testing-libs/naming")
                description.set("This library provides an internal JUnit 5 extension for naming.")
                url.set("https://github.com/whichlicense/testing-libs/naming")
                licenses {
                    license {
...
signing {
    if (project.hasProperty("CI")) {
        ...
        sign(publishing.publications["naming"])
    }
}
